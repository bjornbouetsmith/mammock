...
// used to build the property name like Order.Product.Price for the message.
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllPropertiesMatchConstraint"/> class. 
        /// Initializes a new constraint object.
        /// </summary>
        /// <param name="expected">
        /// The expected object, The actual object is passed in as a parameter to the <see cref="Eval"/> method
        /// </param>
        ...
        protected virtual bool CheckReferenceType(object expected, object actual)
        {
            ...
            {
                _message = string.Format("Expected type '{0}' doesn't match with actual type '{1}'", tExpected.Name, 
                                         tActual.Name);
                return false;
            }
        ...
        protected virtual bool CheckValue(object expected, object actual)
        {
            ...
            if (expected == null)
            {
                if (actual != null)
                {
                    _message = string.Format("Expected value of {0} is null, actual value is '{1}'", BuildPropertyName(), 
                                             actual);
                    return false;
                }
            }
            else
            {
                ...
                {
// if both objects are lists we should tread them as such.
